        ...
        <div className="max-w-xl mx-auto">
          <motion.div
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground/80 mb-2">Точка А (необов'язково)</label>
                  <input
                  type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground/80 mb-2">Точка Б (необов'язково)</label>
                  <input
                  type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground/80 mb-2">Завдання
                </label>
                  <textarea placeholder="Опис вантажу, габарити, особливості"
                rows={2}
                value={form.cargo}
